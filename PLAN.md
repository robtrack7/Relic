...
Immediate active packet: **E8 — Knowledge Creation and Canon Proposals**. Build typed create/edit/relationship/Thread/objective proposal tools on E6's authority kernel and E7's current scoped reads. Every model-created change must remain reversible working state or a pending Approval Queue proposal; deterministic handlers derive scope and expected versions, and no action silently publishes canon. E5.1-E7 are complete at the deterministic gate. No previous hosted-call authorization carries forward; any hosted smoke requires a fresh environment/model/fixture/attempt/cost/cleanup/rollback gate. D5 imported sources remain excluded unless a later explicit GM enrollment contract is added.
