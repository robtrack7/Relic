...
| [[20 - Entity and Canon Schema]] | Data model, canon states, sources, drafts, audit, RLS sketch, Stage evidence markers, exactly-once write receipts, conflict outcomes, and manual Session evidence provenance | Implementation |
| [[21 - Tech Architecture]] | Supabase, RLS, Edge Functions, jobs, sync, Stage packet/audio/write recovery, scoped Storage paths, provider-backed transcription/retry, manual evidence intake, deployment, monitoring | Implementation |
