...
select is((select prompt_version from internal.ai_task_contracts() where task_name='answer_saga_question'),'answer_saga_question@1.3.0','Loom task contract is versioned');
...
select is((select prompt_version from internal.ai_task_runs where guide_turn_id='e3100000-0000-0000-0000-000000000001'),'answer_saga_question@1.3.0','Turn invokes registered task');
