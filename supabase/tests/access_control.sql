...
values
  ...
  ('begin_media_attachment', true, 'Scoped private static-image upload registration RPC.'),
  ('claim_media_attachment_operation', true, 'Owner-scoped private image validation, view, and delete claim RPC.'),
  ('list_media_attachments', true, 'Scoped sanitized private-image metadata projection RPC.'),
  ('update_media_attachment_metadata', true, 'Owner-scoped optimistic GM-authored image metadata writer.'),
...
values
  ...
  ('begin_media_attachment', 'Scoped private static-image upload registration RPC.'),
  ('claim_media_attachment_operation', 'Owner-scoped private image operation claim RPC.'),
  ('complete_media_attachment_validation_for_worker', 'Service-only trusted static-image validation writer.'),
  ('fail_media_attachment_for_worker', 'Service-only stable private-image failure writer.'),
  ('complete_media_attachment_delete_for_worker', 'Service-only private object deletion finalizer.'),
  ('list_media_attachments', 'Scoped sanitized private-image metadata projection RPC.'),
  ('update_media_attachment_metadata', 'Owner-scoped optimistic GM-authored image metadata writer.'),
  ('create_media_attachment_loom_turn_for_worker', 'Worker-only explicit text-only private-image description enrollment.'),
