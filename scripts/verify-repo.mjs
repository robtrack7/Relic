...
const requiredPaths = [
  ...
  "Relic Vault/49 - Backend Module 2 Canon Write Path Plan.md",
  "Relic Vault/51 - Backend Module 3 Approval Queue Plan.md",
  "apps/web/README.md",
  ...
  "supabase/migrations/20260601173429_canon_write_path.sql",
  "supabase/migrations/20260601174516_approval_queue_commit.sql",
  "supabase/seed.sql",
  "supabase/security/rpc-boundary.md",
  "supabase/tests/access_control.sql",
  "supabase/tests/approval_queue.sql",
  "supabase/tests/canon_write_path.sql",
